    ...
    public partial class Inventory : Form
    {
        ...
        public void dataSelect()    // 전체 재고를 보여준다
        {
            ...
            try
            {
                ...
                inventory_dataGridView.Columns["상품이름"].Width = 220;
                inventory_dataGridView.Columns["가격"].Width = 220;
                inventory_dataGridView.Columns["수량"].Width = 220;
            }
            catch (Exception ex)
            {
                // columns 초기화
        ...
        public void stockChangeSelect()    // 전체 재고를 보여준다
        {
            ...
            try
            {
                ...
                inventory_dataGridView.Columns["상품이름"].Width = 220;
                inventory_dataGridView.Columns["변동량"].Width = 220;
                inventory_dataGridView.Columns["시간"].Width = 220;
            }
            catch (Exception ex)
            {
                // columns 초기화
