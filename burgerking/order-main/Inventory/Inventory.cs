    ...
    public partial class Inventory : Form
    {
        ...
        public void dataSelect()    // 전체 재고를 보여준다
        {
            ...
            try
            {
                ...
                inventory_dataGridView.Columns["상품이름"].Width = 140;
        ...
        public void stockChangeSelect()    // 전체 재고를 보여준다
        {
            ...
            try
            {
                ...
                inventory_dataGridView.Columns.Add("판매량", "판매량");
                ...
                reader["sold_quantity"].ToString(),
                reader["time"].ToString(),
            };
                    inventory_dataGridView.Rows.Add(row);
                }

                inventory_dataGridView.Columns["상품이름"].Width = 100;
                inventory_dataGridView.Columns["변동량"].Width = 70;
                inventory_dataGridView.Columns["판매량"].Width = 70;
                inventory_dataGridView.Columns["시간"].Width = 160;
            }
            catch (Exception ex)
            {
                // columns 초기화
